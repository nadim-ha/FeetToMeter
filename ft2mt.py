...
window = Tk()
window.title("Feet to Meter Convert App")
...
convert_btn = Button(window,text="Convert cheers!",bg="dark blue",width=16,command=convert)
convert_btn.grid(column=0,row=3,padx=15)

convert_btn = Button(window,text="Clear",bg="dark blue",width=14,command=clear)
